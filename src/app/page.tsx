          ...
          <div className="max-w-5xl mx-auto px-4 md:px-6">
            <div className="mx-auto grid max-w-5xl items-center gap-6 lg:grid-cols-2 lg:gap-12">
              <div className="space-y-4">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Advanced AI Analysis</h2>
              ...
              <div className="grid gap-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>We analyze the language, tone, and claims made in the article.</CardDescription>
                  </CardHeader>
                </Card>
                <Card>
                  <CardHeader>
                    <CardTitle>Source Verification</CardTitle>
                    <CardDescription>We check the credibility of the source and author.</CardDescription>
                  </CardHeader>
                </Card>
                <Card>
                  <CardHeader>
                    <CardTitle>Fact Checking</CardTitle>
                    <CardDescription>We compare claims against verified facts and trusted sources.</CardDescription>
                  </CardHeader>
                </Card>
              </div>
            </div>
